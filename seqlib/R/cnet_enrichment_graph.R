##ADAPTED FROM https://github.com/GuangchuangYu/DOSE/blob/172b35bf886fafc80cdb2263845fb60e885b8360/R/cnetplot.R
library(igraph)
library(scales)
...
##' @author Guangchuang Yu \url{http://ygc.name}
cnetplot_internal_g <- function(inputList,
...
cnetplot_enrichment_graph <- function(x,
                                      showCategory = 5,
                                      categorySize = "geneNum",
                                      foldChange   = NULL,
                                      fixed        = TRUE,
    ...
    g = cnetplot_internal_g(inputList=gc,
